  ...
  return (
    <Card
      className={`
        ...
        ${isSelected
          ? 'ring-2 ring-[#2F80ED] bg-blue-50/50 dark:bg-blue-950/20'
    ...
    >
      ...
      {isSelected && (
        <div className="absolute top-2 right-2 z-10">
          <div className="w-6 h-6 bg-gradient-to-r from-[#2F80ED] to-[#56CCF2] rounded-full flex items-center justify-center">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <div className="p-1.5 sm:p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex-shrink-0">
              <Plane className="w-4 h-4 sm:w-5 sm:h-5 text-[#2F80ED] dark:text-cyan-400" />
            </div>
